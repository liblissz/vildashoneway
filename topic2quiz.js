const datas = [
    {
      id: 1,
      question: `how do we declare  integer variable in c#`,
      choices: [
        `int`,
        `number`,
        `char`,
    ...
    {
      id: 2,
      question: `example of and integer is`,
      choices: [
        `10`,
        `10.23`,
        `12b`,
   ...
   // 671843174
    {
      id: 3,
      question: `how do we declare a sentence in c?`,
      choices: [
        `string`,
        `char`,
        `double`,
  ...
  window.location.href = 'csharpc3.html';
    });
